...
test("pnpm pack ships an executable localapp binary", async (t) => {
  ...
  const tarball = path.join(projectDirectory, "tmp/localapp-package/localapp-0.2.7.tgz");
  ...
  assert.equal(version.stdout.trim(), "localapp 0.2.7");
  ...
  assert.equal(installedVersion.stdout.trim(), "localapp 0.2.7");
