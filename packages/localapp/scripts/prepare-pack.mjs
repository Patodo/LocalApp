...
await fs.rm(path.join(packageDirectory, "runtime"), { recursive: true, force: true });
...
await fs.cp(path.join(artifact.outputDirectory, "runtime"), path.join(packageDirectory, "runtime"), { recursive: true });
